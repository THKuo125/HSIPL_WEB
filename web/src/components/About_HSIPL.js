...
import life32 from "../img/Photos of life/20231220.jpg";
import life33 from "../img/Photos of life/2023.12.21老師生日.jpg";
import life34 from "../img/Photos of life/2024尾牙.jpg";
import life35 from "../img/Photos of life/2024.03聚餐.jpg";
import life36 from "../img/Photos of life/實驗室餐聚_2024.05.jpg";
    ...
    return (
        <>
            <div className="all_life">
                ...
                <div>
                        <img id="life" src={life36} alt="life" />
                    </div>
                    <div>
                        <img id="life" src={life35} alt="life" />
                    </div>
                    <div>
                        <img id="life" src={life34} alt="life" />
                    </div>
                    <div>
                        <img id="life" src={life33} alt="life" />
                    </div>
                    
                    <div>
                        <img id="life" src={life32} alt="life" />
                    </div>
          ...
          <div className="Web">
                    ...
                    <div className="content_AH">
                        <div className="video">
                            <iframe
                                width="100%"
                                height="630"
                                src="https://www.youtube.com/embed/NMExquRcMtA?si=mT2tFP4qw6YPyyF_"
            ...
            */}
                    ...
                    <div className="red">
                        <span>
                            <b>希望找指導教授之學生請注意:
                            Email請註明正取或備取名次，並附上個人基本資料履歷(包含熟悉之程式語言、曾做過之專題題目等)以及成績單，謝謝。
                            </b>
                        </span>
                    </div>
                </div>
