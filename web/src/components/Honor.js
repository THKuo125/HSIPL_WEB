                ...
                >
                    ...
                    <div className="pic_hon" id="secondpic">
                        <div className="all">
                            ...
                            <Image
                                className="column_Pic"
                                src={img_2022calculate}
                                alt="2022chinacalaulate"
                            />
                            <div className="detail_hon">
                                <h3>
                                    本實驗室團隊
                    ...
                    <div className="pic_hon" id="secondpic">
                        <div className="all">
                            ...
                            <Image
                                className="column_Pic"
                                src={img_110Topic}
                                alt="img2021TopicWinning"
                            />
                            <div className="detail_hon">
                                <h3>
                                    本實驗室專題生歐俊毅、張元懷、張哲維 同學
                                    榮獲{" "}
                                    <span className="red">
                                        2021實務專題競賽暨成果發表觀摩會 佳作
                                    </span>
                                    <br />
                                    題目： 雲科校園花朵辨識
                                    <br />
                    ...
                    <div className="pic_hon" id="secondpic">
                        <div className="all">
                            ...
                            <Image
                                className="column_Pic"
                                src={img_IEEE_2021OCT}
                                alt="imgIEEEECICEB"
                            />
                            <div className="detail_hon">
                                <h3>
                                    本實驗室陳士煜教師與實驗室研究生 蔡逢記 同學
                                    榮獲{" "}
                                    <span className="red">
                                        {" "}
                                        2021 IEEE ECICE Best Conference Paper
                                        Award
                                    </span>
                                    <br />
                                    <br />
                            ...
                            <div className="detail_hon">
                                <h3>
                                    ...
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        href="https://youtu.be/6qvTLNq84AU?t=87"
                                    >
                                        雲創盃創新競賽
                                    </a>
                                </h3>
                        ...
                        <div className="all">
                            ...
                            <div className="detail_hon">
                                <h3>
                                    ...
                                    <br></br>
                                    題目：
                                    <span className="name">臺灣好所在</span>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pic_hon" id="lastpic">
                        <div className="all">
                            ...
                            <div className="detail_hon">
                                <h3>
                                    本實驗室莊尚儒同學榮獲DIGI+Talent
                                    跨域數位人才加速躍升計畫 - DIGI+
                                    數位新星大賞 　
                                    <span className="red">一星大賞</span>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pic_hon" id="lastpic">
                        <div className="all">
                            ...
                            <div className="detail_hon">
                                <h3>
                                    本實驗室林力瀚同學參加韓國舉辦KAGIS研討會論文
                                    A Modified Watershed Algorithm for LiDAR
                                    Image Segmentation得到
                                    <span className="red"> Best Paper </span>
                                    獎項!
                                </h3>
                            </div>
                        </div>
