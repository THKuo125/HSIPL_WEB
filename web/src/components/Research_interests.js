...
import twincn from "../img/LOGO/twincn.jpg";
import civilmap from "../img/LOGO/civilmap.jpg";
import corning from "../img/LOGO/corning.jpg";
import gips from "../img/LOGO/gips.png";
import isuzu_optics from "../img/LOGO/isuzu_optics.jpg";
import norky from "../img/LOGO/norky.png";
import nstc from "../img/LOGO/nstc.jpg";
import tari from "../img/LOGO/tari.svg";
    ...
    return (
        <div className="Research_interests" id="Research_interests">
            ...
            <span>
                ...
                algorithms for multi/hyperspectral image and medical image
                processing, specifically for image classification, endmember
                finding and virtually dimensionality (VD). For hyperspectral
                image, this field is considered as a fast growing area and its
                related technologies have been widely used in many applications,
                such as food safety and inspection in agriculture, mineral
                mapping in geology, land use/cover classification, ecology
                monitoring, chemical defense, law enforcement, military defense,
                and medical imaging, etc. The main themes of my Ph.D.
                dissertation are algorithm design and analysis for hyperspectral
                endmember finding.
            </span>
            {/* <span className="Ch">
            ...
            <div className="article">
                ...
                <div className="Item">
                    ...
                    <iframe
                        width="300"
                        height="200"
                        src="https://www.youtube.com/embed/eVImK2GwWQk"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen
                ...
                <div className="Item">
                    ...
                    <div className="Item">
                        ...
                        <h3>
                            高光譜技術利用AI深度學習演算法並結合機械手臂，對於生咖啡的品質進行即時性的瑕疵檢測，準確率可達94%
                        </h3>
                    </div>
                <div className="Item">
                    <h1>花生品質檢測</h1>
...
const Projects_data = [
    {
        name: "高光譜影像檢測技術於食品安全之開發以瑕疵檢測及新鮮度為例",
        date: "2023/08/01 ~ 2024/07/31",
        unit: "國科會",
        money: "800,000",
    },
    {
        name: "即時自動化高光譜瑕疵檢測系統以智慧農業為例",
        date: "2023/06/01 ~ 2024/05/31",
        unit: "國科會",
        money: "705,000",
    },
    {
        name: "高光譜即時運算平台開發",
        date: "2023/02/01 ~ 2024/03/31",
        unit: "五鈴光學",
        money: "500,000",
    },
    {
        name: "儲格影像辨識系統",
        date: "2022/07/01 ~ 2023/01/31",
        unit: "吉普斯科技股份有限公司",
        money: "200,000",
    },
    {
        name: "高光譜即時運算開發平台(III)",
    ...
    {
        name: "AI玻璃影像辨識系統",
        date: "2021/08/01 ~ 2023/02/28",
        unit: "-",
        money: "1,000,000",
    },
    {
        name: "千分之一地形圖自動化比對研究",
        date: "2021/03/18 ~ 2022/02/28",
        unit: "吉普司科技股份有限公司",
        money: "338,000",
    },
    {
        name: "高光譜智慧新農業之花生瑕疵篩選技術",
        date: "2020/11/01 ~ 2021/10/31",
        unit: "科技部",
        money: "600,000",
    },
    {
    ...
    {
        name: "高光譜即時運算平台開發(II)",
        date: "2020/09/01 ~ 2021/10/31",
        unit: "五鈴光學股份有限公司",
        money: "650,000",
    },
    {
        name: "應用高光譜影像辨識技術發展智慧新農業以提升農產品質管理為例",
        date: "2020/08/01 ~ 2023/07/31",
        unit: "科技部",
        money: "2175,000",
    },
    {
        name: "道路挖掘影像辨識系統",
        date: "2020/06/01 ~ 2021/05/31",
        unit: "坤眾科技股份有限公司",
        money: "350,000",
    },
    {
        name: "高光譜智慧辨識技術平台開發",
        date: "2019/11/01 ~ 2020/10/31",
        unit: "科技部",
        money: "570,000",
    },
    {
        name: "高光譜即時運算平台開發",
        date: "2019/08/01 ~ 2020/07/31",
        unit: "五鈴光學",
        money: "500,000",
    },
    {
        name: "運用高光譜遙測技術與深度學習發展智慧森林環境監控",
        date: "2018/08/01 ~ 2020/07/31",
        unit: "科技部",
        money: "1,532,000",
    },
    {
        name: "手持式高光譜影像及訊號雲端藥品檢測開發技術",
        date: "2018/04/01 ~ 2019/03/31",
        unit: "五鈴光學股份有限公司",
        money: "700,000",
    },
    {
        name: "高光譜影像端元擷取技術的開發與應用(II)",
        date: "2017/08/01 ~ 2018/07/31",
        unit: "科技部",
        money: "539,000",
    },
    {
        name: "應用Sentinel-2衛星開發森林生態系特徵參數的評估技術-實現Vietnam Mekong River Delta濕地森林永續性的先驅研究",
        date: "2017/06/01 ~ 2019/05/31",
        unit: "科技部",
        money: "1,326,000",
    },
    {
        name: "基於資訊理論的高光譜影像波段選擇方法之研究",
        date: "2016/08/01 ~ 2017/09/30",
        unit: "科技部",
        money: "527,000",
    },
    {
        name: "高光譜影像端元擷取技術的開發與應用",
        date: "2016/08/01 ~ 2017/08/31",
        unit: "科技部",
        money: "527,000",
    },
    {
        name: "應用高光譜檢測果實農藥殘留技術之研發",
        date: "2015/01/01 ~ 2015/12/31",
        unit: "農業試驗所",
        money: "2,000,000",
    },
    {
        name: "高光譜影像異物偵測分析之研究 II",
        date: "104年度",
        unit: "科技部",
        money: "741,000",
    },
    {
        name: "循序式演算法於高光譜訊號像元分解之研究",
        date: "104年度",
        unit: "科技部",
        money: "610,000",
    },
    {
        name: "結合衛載及空載光達資料與多譜影像估測台灣森林碳存量技術之開發(III)",
        date: "104年度",
        unit: "科技部",
        money: "673,000",
    },
...
export const UniversityIndustryCooperation = () => {
    return (
        <div
            className="UniversityIndustryCooperation"
            id="UniversityIndustryCooperation"
        >
...
const UniversityIndustryCooperation_columns = [
    { title: "計畫名稱", dataIndex: "name" },
    { title: "起訖日期", dataIndex: "date" },
    { title: "補助單位", dataIndex: "unit" },
    { title: "經費總額", dataIndex: "money" },
...
const UniversityIndustryCooperation_data = [
    {
        name: "儲格影像辨識系統",
        date: "2022/07/01 ~ 2023/01/31",
        unit: "吉普斯科技股份有限公司",
