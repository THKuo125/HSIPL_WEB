...
const Projects_data = [
  { name: '儲格影像辨識系統', date: '2022/07/01 ~ 2023/01/31', unit: '吉普斯科技股份有限公司', money: '200,000' },
  { name: '高光譜即時運算開發平台(III)', date: '2022/01/01 ~ 2023/02/28', unit: '五鈴光學股份有限公司', money: '350,000' },
  { name: '基本圖影像檔AI自動化辨識', date: '2022/01/01 ~ 2023/02/28', unit: '毅錡國際數位股份有限公司', money: '500,000' },
