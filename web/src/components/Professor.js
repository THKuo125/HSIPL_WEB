            ...
            <div className="content">
                ...
                <div className="Info">
                    ...
                    <div className="resume" id="Education">
                        <p>
                        陳士煜老師具有豐富的高光譜影像、影像辨識、人工智慧等研究與實務經驗，致力指導學生參與各種國內外競賽，並屢次取得優異成績。在學術上，曾獲得眾多榮譽例如「國際發明展金牌」、「科技部優秀年輕學者研究計畫」、「國科會/科技部大專校院特殊優秀人才獎勵」、「中華民國電腦學會傑出青年學者獎」、「雲林科技大學研發績優新人獎」與「嶺東中學創校50週年傑出校友獎」等。
                        </p>
                        <p>
                        陳士煜老師的研究領域廣泛，包括環境監控、全球暖化議題、智慧農業、智慧製造等。這些研究成果不僅是學術上的突破，更是對產業發展的實質貢獻，有助於提升生產效率、品質管控，並推動智慧製造技術的應用與發展。
                        </p>
                    </div>
                </div>
            </div>
...
const data = [
    {
        ...
        content1: "",
        content2:
            " Lin, Chinsu; Li, Guan-Jie; Hsu, Yu-Chun; Liu, Keng-Hao. 2021.",
    ...
    },
    {
        ...
        content1: "",
        content2:
            " Chuan-Yu Chang, Cheng-Syue OU and Chou-Tien Lien (2020, Jul). ",
    ...
    },
    {
        ...
        content2:
            " Hsiao-Chi Li, Hsian-Min Chen and Chein-I Chang (2015, Jun). ",
